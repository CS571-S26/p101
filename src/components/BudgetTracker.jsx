...
export default function BudgetTracker({
  ...
  useEffect(() => {
    fetch(`/api/trips/${tripId}/expenses`)
      ...
      .then((data) => {
        ...
        if (data.expenses.length > 0) setExpenses(data.expenses.map(fromApi));
      })
  ...
  const calcBalances = () => {
    ...
    expenses.filter((e) => !e.settled).forEach((e) => {
      ...
      e.splitAmong.forEach((mid) => { bal[mid] = (bal[mid] || 0) - share; });
    });
    return bal;
  };
  ...
  const displayedExpenses = viewMode === 'event'
  ...
  return (
    <div className="budget-tracker">
      ...
      <div className="bt-container">
        ...
        {/* ── Stat Grid ── */}
        <div className="bt-stats-section">
          <div className="bt-stat-grid">
            <div className="bt-stat-card">
              <div className="bt-stat-row">
                ...
                <DollarSign size={16} className="bt-stat-icon neutral" />
              </div>
            ...
            <div className="bt-stat-card">
              <div className="bt-stat-row">
                ...
                <TrendingUp size={16} className="bt-stat-icon accent" />
              </div>
            ...
            <div className="bt-stat-card">
              <div className="bt-stat-row">
                ...
                {remaining >= 0
                  ? <TrendingDown size={16} className="bt-stat-icon success" />
                  : <TrendingUp   size={16} className="bt-stat-icon danger" />}
              </div>
            ...
            <div className="bt-stat-card">
              <div className="bt-stat-row">
                ...
                <Users size={16} className="bt-stat-icon neutral" />
              </div>
              <div className="bt-stat-value neutral">
        ...
        {/* ── Controls ── */}
        <div className="bt-controls-section">
        ...
        {/* ── Expense List ── */}
        <div className="bt-expenses-header">
        ...
        {Object.keys(categoryBreakdown).length > 0 && (
          <div className="bt-breakdown-section">
                ...
                return (
                  <div key={cat} className="bt-breakdown-row">
                    <div className="bt-breakdown-info">
                      ...
                      <span className="bt-breakdown-amt">
                        {currency} {amt.toLocaleString(undefined, { maximumFractionDigits: 2 })}
                      </span>
                    </div>
    ...
    <div className="bt-expense-item">
      ...
      <div className="bt-expense-right">
        ...
        <div className="bt-expense-actions">
          ...
          <button className="bt-action-btn edit" title="Edit" onClick={() => onEdit(expense)}>
            <Edit size={16} />
          </button>
          <button className="bt-action-btn delete" title="Delete" onClick={() => onDelete(expense.id)}>
            <Trash2 size={16} />
          </button>
        </div>
      </div>
...
function ExpenseModal({ members, onClose, onSave, initialData = null, isEdit = false }) {
  ...
  const [form, setForm] = useState(
    initialData ? { ...initialData, amount: String(initialData.amount) } : blank
  );
  ...
  const handleSubmit = (e) => {
    ...
    onSave({ ...form, amount: parseFloat(form.amount), id: initialData?.id || '' });
  };
        ...
        <div className="bt-modal-body">
          ...
          {settlements.length === 0 ? (
            <div className="bt-settle-clear">
              <CheckCircle size={38} className="bt-settle-clear-icon" />
                ...
                return (
                  <div key={idx} className="bt-settle-row">
                    <div className="bt-settle-parties">
                      ...
                      <ArrowRightLeft size={13} className="bt-settle-arrow" />
